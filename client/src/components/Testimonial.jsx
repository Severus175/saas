...
const Testimonial = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 py-24 bg-black text-white'>
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {dummyTestimonialData.map((testimonial, index) => (
          <div
            key={index}
            className='p-8 m-4 max-w-xs rounded-xl bg-[#111111] border border-purple-600/30 shadow-[0_0_15px_#8b5cf6] hover:shadow-purple-500/50 hover:-translate-y-1 transition duration-300 cursor-pointer'
          >
            ...
            <div className='flex items-center gap-4'>
              <img src={testimonial.image} className='w-12 h-12 object-cover rounded-full border border-purple-500/40' alt='' />
