    ...
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-white'>
      ...
      >
        ...
        <input
          ...
          className='w-full mt-2 p-2 px-3 text-sm rounded-md bg-[#1e1e1e] text-white border border-gray-600 outline-none'
          required
        />
      ...
      {/* Right col */}
      <div className='w-full max-w-lg p-4 bg-[#141414] rounded-lg flex flex-col border border-gray-700 min-h-96 max-h-[600px]'>
        <div className='flex items-center gap-3'>
